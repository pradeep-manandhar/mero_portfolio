...
<form action="#" method="POST">
    ...
    <select name="username" id="username" class="form-select" aria-label="Default select example" value="">
    ...
    <div class="mb-3">
        ...
        <select name="skill_category" id="skill_category" class="form-select" aria-label="Default select example" >
